...
var ForkTsCheckerWebpackPlugin = /** @class */ (function () {
    ...
    ForkTsCheckerWebpackPlugin.prototype.registerCustomHooks = function () {
        ...
        this.compiler.hooks.forkTsCheckerCancel = new tapable_2.SyncHook(['cancellationToken']);
        this.compiler.hooks.forkTsCheckerServiceStartError = new tapable_2.SyncHook(['error']);
        this.compiler.hooks.forkTsCheckerWaiting = new tapable_2.SyncHook(['hasTsLint']);
        this.compiler.hooks.forkTsCheckerServiceStart = new tapable_2.SyncHook(['tsconfigPath', 'tslintPath', 'watchPaths', 'workersNumber', 'memoryLimit']);
        this.compiler.hooks.forkTsCheckerReceive = new tapable_2.SyncHook(['diagnostics', 'lints']);
        this.compiler.hooks.forkTsCheckerServiceOutOfMemory = new tapable_2.SyncHook([]);
        this.compiler.hooks.forkTsCheckerEmit = new tapable_2.SyncHook(['diagnostics', 'lints', 'elapsed']);
        this.compiler.hooks.forkTsCheckerDone = new tapable_2.SyncHook(['diagnostics', 'lints', 'elapsed']);
    ...
    ForkTsCheckerWebpackPlugin.ALL_CPUS = os.cpus() ? os.cpus().length : 1;
